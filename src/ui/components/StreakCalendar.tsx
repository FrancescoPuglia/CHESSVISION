...
export const StreakCalendar: React.FC<StreakCalendarProps> = ({ className = '' }) => {
  ...
  const calculateStats = (data: StreakData[]) => {
    ...
    const hasRecentActivity = sorted.some(d => d.date === today || d.date === yesterday);
    ...
    <div className={className} style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ color: '#a0a0a0', fontSize: '0.8rem' }}>Giorni attuali</div>
        </div>
        ...
        {days.map((day) => (
          <div
            ...
            style={{
              ...
              fontWeight: 'bold',
              border: day.date === new Date().toISOString().split('T')[0] ? '2px solid #ffd700' : 'none',
              position: 'relative',
              cursor: 'help'
            }}
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.25rem' }}>
          <div style={{ width: '12px', height: '12px', backgroundColor: '#2d3142', borderRadius: '2px' }} />
          <span>Nessuna</span>
        </div>
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.25rem' }}>
      ...
      {currentStreak > 0 && (
        <div style={{
          ...
          🎉 Ottimo lavoro! Hai mantenuto la serie per {currentStreak} giorni consecutivi!
