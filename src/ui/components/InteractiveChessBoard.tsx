...
export const InteractiveChessBoard: React.FC<InteractiveChessBoardProps> = ({ 
  ...
  const handleSquareClick = (square: string) => {
    ...
    if (selectedSquare === null) {
      ...
      const validMove = game.isValidMove(moveAttempt.from as Square, moveAttempt.to as Square);
  ...
  return (
    <div className={`chess-board-container ${className}`} style={{
      ...
      <div 
        ...
        style={{
          display: 'grid',
          gridTemplateColumns: showCoordinates ? '24px repeat(8, 70px) 24px' : 'repeat(8, 70px)',
          gridTemplateRows: showCoordinates ? '24px repeat(8, 70px) 24px' : 'repeat(8, 70px)',
          gap: '0',
        ...
        {position.map((row, rowIndex) => {
          ...
          return [
            ...
            ...row.map((piece, colIndex) => {
              ...
              const hasValidMove = allowMoves && game.hasValidMovesFrom(square as Square);
              ...
              return (
                <div
                  ...
                  style={{
                    ...
                    width: '70px',
                    height: '70px',
                    cursor: allowMoves ? (hasValidMove || isPossibleMove ? 'pointer' : 'default') : 'default',
                    ...
                    overflow: 'hidden',
                    border: isPossibleMove ? '2px solid rgba(32, 191, 107, 0.8)' : 'none'
                  }}
      ...
      <div style={{
        ...
        {lastMove && (
          <div style={{
            ...
            <span>Ultima mossa: {lastMove.from.toUpperCase()}-{lastMove.to.toUpperCase()}</span>
          </div>
        )}
