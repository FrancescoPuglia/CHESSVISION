...
export const VoiceSettings: React.FC<VoiceSettingsProps> = ({
  ...
  const testVoice = () => {
    if (speechService) {
      speechService.speak(
        "Questa è una prova della voce selezionata per ChessVision.",
      );
    }
  };
  ...
  return (
    ...
    >
      ...
      >
          ...
          >
            ...
            {voices.map((voice) => (
              <option key={voice.name} value={voice.name}>
                ...
                {voice.localService ? "(Locale)" : "(Remota)"}
              </option>
            ))}
          </select>
        </div>
        ...
        >
          💡 <strong>Suggerimento:</strong> Le voci locali offrono prestazioni
          migliori e maggiore privacy. Le impostazioni vengono salvate
